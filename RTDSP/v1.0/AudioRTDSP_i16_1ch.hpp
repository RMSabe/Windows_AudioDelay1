...
#ifndef AUDIORTDSP_I16_1CH_HPP
#define AUDIORTDSP_I16_1CH_HPP

#include "AudioRTDSP.hpp"

class AudioRTDSP_i16_1ch : public AudioRTDSP {
	public:
		AudioRTDSP_i16_1ch(const audiortdsp_pb_params_t *p_params);
		~AudioRTDSP_i16_1ch(VOID);
