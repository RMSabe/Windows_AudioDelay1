...
#ifndef AUDIORTDSP_I24_2CH_HPP
#define AUDIORTDSP_I24_2CH_HPP

#include "AudioRTDSP.hpp"

class AudioRTDSP_i24_2ch : public AudioRTDSP {
	public:
		AudioRTDSP_i24_2ch(const audiortdsp_pb_params_t *p_params);
		~AudioRTDSP_i24_2ch(VOID);
